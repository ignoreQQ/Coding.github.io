...
addProblem({
    id: 415,
    title: "ca0415",
    description: "每兩個月就可以對一次發票，看看這次是否有財神爺降臨到自己頭上，而這次規則如下:會給六組數字，每組數字皆為五位數第一組為特別獎(獎金10000)第二組為特獎(獎金2000)第三、四、五組為頭獎(獎金800)若號碼末4位與頭獎號碼相同則為貳獎(獎金400)若號碼末3位與頭獎號碼相同則為参獎(獎金100)前面三個獎項需要號碼完全相同方可獲獎第六組為自己的號碼，請判斷是否有中獎如果有中獎請輸出中獎金額，如果沒有中獎請輸出0如果有中兩種或兩種以上的獎項，請擇優輸出",
    language: "c",
    code: `#include <stdio.h>
